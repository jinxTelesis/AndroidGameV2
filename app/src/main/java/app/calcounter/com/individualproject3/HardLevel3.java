            ...
            if(startAnimationCounter == 7)
            {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ScoreViewModel actViewModel = ViewModelProviders.of(HardLevel3.this).get(ScoreViewModel.class);
                        actViewModel.setPlayerTotalScore(playerScore);
                        actViewModel.saveScore(HARDSCORE3);
                        ...
                        editor.putInt(HARDSCORE3, playerScore);
                        editor.apply();
